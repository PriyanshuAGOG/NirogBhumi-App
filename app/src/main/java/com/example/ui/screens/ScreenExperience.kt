...
private val RouteDestinations = mapOf(
    ...
    "learn_hub" to mapOf("Diabetes" to "articles", "Sleep" to "articles", "Yoga" to "articles", "Naturopathy" to "articles", "BP" to "articles"),
...
val PrimaryDestinations = mapOf(
    ...
    "articles" to "article_detail", "article_detail" to "learn_hub", "orders" to "order_detail",
